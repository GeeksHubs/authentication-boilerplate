...
export declare type RequestLogger = (response: HttpResponse, httpRegion?: HttpRegion) => Promise<void>;
export declare type StreamLogger = (channel: string, type: string, message: unknown) => Promise<void>;
